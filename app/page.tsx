            ...
            <div className="space-y-8">
              ...
              {clauses.length > 0 ? (
                ...
                >
                  ...
                  >
                    {/* Low Risk Card */}
                    <motion.div variants={clauseCardReveal}>
                      <Card riskLevel="info" className="flex h-full flex-col justify-between">
                        <CardHeader>
                          ...
                          <CardTitle className="mt-2 text-base">Security Deposit Refund</CardTitle>
                          <CardDescription>
                            Standard 30-day refundable deposit cycle adhering to model tenancy acts.
                          </CardDescription>
                        </CardHeader>
                    ...
                    <motion.div variants={clauseCardReveal}>
                      <Card riskLevel="caution" className="flex h-full flex-col justify-between">
                        <CardHeader>
                          ...
                          <CardTitle className="mt-2 text-base">Notice Period Disparity</CardTitle>
                          <CardDescription>
                            Requires 60 days notice from tenant but only 15 days from the landlord.
                          </CardDescription>
                        </CardHeader>
                        <CardContent className="mx-6 rounded bg-secondary/30 p-3 font-mono text-xs text-muted-foreground">
                    ...
                    {/* High Risk Card */}
                    <motion.div variants={clauseCardReveal}>
                      <Card riskLevel="high-risk" className="flex h-full flex-col justify-between">
                        <CardHeader>
                          <div className="flex items-center justify-between">
                            <span className="font-mono text-xs text-muted-foreground">
                              § 14.2 INDEMNITY
                          ...
                          <CardDescription>
                            Worker holds platform harmless for third-party claims without reciprocal
                            obligation.
                          </CardDescription>
                        </CardHeader>
                        <CardContent className="mx-6 rounded bg-secondary/30 p-3 font-mono text-xs text-muted-foreground">
            ...
            <div>
              {activeDoc ? (
                ...
                <div className="space-y-4 rounded-lg border border-dashed border-border bg-card p-12 text-center">
                  ...
                  <p className="mx-auto max-w-md text-sm text-muted-foreground">
                    NyaySetu Q&amp;A operates on a strictly grounded document scope. Please upload a
                    rental deed, platform agreement, or contract onto the Case Intake Desk to begin
                    an inquiry with citation anchors.
                  </p>
                  <Button variant="brass" onClick={() => setActiveView("intake")}>
                    Go to Intake Desk
                  </Button>
              ...
              {activeDoc ? (
                ...
                <div className="space-y-4 rounded-lg border border-dashed border-border bg-card p-12 text-center">
                  ...
                  <p className="mx-auto max-w-md text-sm text-muted-foreground">
                    ...
                    automatically from high-risk clauses. Please place a document on the intake desk
                    first.
                  </p>
                  <Button variant="brass" onClick={() => setActiveView("intake")}>
                    Go to Intake Desk
