...
_Figure 2: Tracked-changes contract comparison mode with citizen advantage badges (`Favors Citizen` / `Disadvantages Citizen`) alongside grounded consultation Q&A with source clause citations._
